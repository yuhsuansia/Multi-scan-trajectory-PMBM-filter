...
for t = 1:K
    ...
    [trajectoryMBM,MB_birth] = predictStep(trajectoryMBM,model,t);
    
    % Update all predicted single target hypotheses of previous scan
    trajectoryUpdMBM = updateStep(MB_birth,trajectoryMBM,model,measlog{t},t);
    
    % Multi-scan data association
    [trajectoryEst,trajectoryMBM] = dataAssoc(trajectoryUpdMBM,model);
    ...
    % (Filtering or smoothing) performance evaluation using trajectory metric
